 ...
 * This class implements a Java interface to the 'test_msg'
 * message type.
 */

public class test_msg extends net.tinyos.message.Message {
    ...
    /** Create a new test_msg of size 102. */
    public test_msg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new test_msg of the given data_length. */
    public test_msg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new test_msg with the given data_length
     * and base offset.
     */
    public test_msg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new test_msg using the given byte array
     * as backing store.
     */
    public test_msg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public test_msg(byte[] data, int base_offset) {
     ...
     */
    public test_msg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new test_msg embedded in the given message
     * at the given base offset.
     */
    public test_msg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public test_msg(net.tinyos.message.Message msg, int base_offset, int data_length) {
